...
def probe(target,name,omit,local_types=(),extra_flags=()):
    reference=fresh_verify(target,dest=ROOT/'build/tu-context/game-menu/research-20260924-update-game-menu-next'/'reference')
    ...
    for label,variant in variants:
        ...
        out=ROOT/'build/tu-context/game-menu/research-20260924-update-game-menu-next'/label; out.mkdir(parents=True,exist_ok=True)
    ...
    path=ROOT/'docs/attempts/research-20260924-update-game-menu-next'/'compiler-context.json'
    if path.exists():
