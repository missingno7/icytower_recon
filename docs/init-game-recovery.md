...
The current source candidate is a 1,989-byte `DIFFER` body. It fixes the DWARF
...
to the menu/game sound slots, and allocates the swap buffer,
...
remaining 3,799 bytes cover the original network, graphics fallback,
resource-loader,
