...
docs/attempts/research-luna-profile-interface/build/profile-interface-header-only-v1/unit.o:     file format pe-i386
...
0000089c <_profile_data_page_advanced>:
     ...
     981:	31 ff                	xor    %edi,%edi
     983:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
