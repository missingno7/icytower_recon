...
def main():
    ...
    reports={}
    for target in ['game-beta','game-control','game-csv','game-custom','game-directories','game-fld-adspot','game-main-partial','game-map','game-menu','game-particle','game-replay','game-scroller','game-stars','game-timer','allegro-timer','allegro-color','allegro-blit','allegro-logg']:
    ...
    games=[reports['game-beta'],reports['game-control'],reports['game-custom'],reports['game-directories'],reports['game-fld-adspot'],reports['game-main-partial'],reports['game-map'],reports['game-menu'],reports['game-particle'],reports['game-replay'],reports['game-scroller'],reports['game-stars'],timer]
    ...
    for target in ['game-beta','game-control','game-csv','game-custom','game-directories','game-fld-adspot','game-main-partial','game-map','game-menu','game-particle','game-replay','game-scroller','game-stars','game-timer']:
