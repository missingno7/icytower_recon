...
The current source candidate is a 1,493-byte `DIFFER` body. It fixes the DWARF
...
the datafile, allocates the swap buffer,
...
remaining 4,295 bytes cover the original network, resource-loader,
