...
GROUPS={
    'function':('test_link_object_cache','test_grinder','test_control_transfers','test_scheduling_diagnostics',
                ...
                'test_data_owners','test_dwarf_locations','test_compound_probe','test_predicate_probe','test_pointee_migration','test_compiler_context',
                'test_branch_diagnostics','test_data_tasks'),
    'interface':('test_type_trial_context','test_reconsider_type','test_pointee_tasks','test_pointee_migration','test_link_object_cache','test_grinder','test_contribution_diagnostics','test_scheduling_diagnostics','test_control_transfers',
