...
GROUPS={
    'function':('test_grinder','test_control_transfers','test_scheduling_diagnostics',
                'test_literal_diagnostics','test_literal_dependencies','test_reference_diagnostics','test_atomic_writes',
    ...
    'interface':('test_grinder','test_scheduling_diagnostics','test_control_transfers',
                 'test_literal_diagnostics','test_literal_dependencies','test_reference_diagnostics','test_global_type_tasks',
