...
The current source candidate is a 995-byte `DIFFER` body. It fixes the DWARF
...
and each persisted table, increments the ordinary-run counter, processes
...
remaining 4,793 bytes cover the original network, resource-loader,
