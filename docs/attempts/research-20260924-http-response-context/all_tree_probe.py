...
result = {"flags": ["-fdump-tree-all", "-fdump-rtl-all"], "cohorts": {}}
...
(folder / "all-tree-results.json").write_text(json.dumps(result, indent=2) + "\n")
