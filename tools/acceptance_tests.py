...
GROUPS={
    'function':('test_grinder','test_control_transfers','test_scheduling_diagnostics',
                'test_literal_diagnostics','test_reference_diagnostics','test_atomic_writes',
    ...
    'interface':('test_grinder','test_scheduling_diagnostics','test_control_transfers',
                 ...
                 'test_atomic_writes','test_data_owners','test_interface_tasks','test_typed_interface_tasks',
