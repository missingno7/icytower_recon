...
GROUPS={
    ...
    'interface':('test_reconsider_type','test_pointee_tasks','test_pointee_migration','test_link_object_cache','test_grinder','test_contribution_diagnostics','test_scheduling_diagnostics','test_control_transfers',
