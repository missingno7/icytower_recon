...
def main():
    ...
    if a.json:
        ...
        for callee in card.get('callee_interface_scope',{}).get('observations',[])[:3]:
            if callee['blocking']: print('  callee interface prerequisite %s: %s; %s'%(callee['function'],callee['reason'],callee['candidate_card']))
